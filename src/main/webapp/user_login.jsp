...
<head>
<meta charset="UTF-8">
<title>CureWell | User Login</title>
...
<body>
	...
	<div class="d-flex align-items-center justify-content-center" style="min-height: 90vh; position: relative; z-index: 1;">
	    ...
	    ">
	        <div class="card-body">
	            <p class="fs-3 text-center fw-bold text-dark">User Login</p>
	            ...
	            <div class="text-center mt-3">
	            	<small class="text-dark">Don't have an account?
	            		<a href="signup.jsp" class="text-decoration-none fw-semibold text-primary">Create one</a>
	            	</small>
	            </div>
	        </div>
	    </div>
